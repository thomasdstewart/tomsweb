...
into what was going on. It turns out to just be fairly straight forward, all web
...
Yikes was my first reaction, bmi.js was nice an un-readable, however if you
reformat it a bit it's mostly readable, it's on
[pastebin](http://pastebin.com/Ht32CTDS) if your interested. As an aside 1.2.3.4
...
Well at least that are not using genuine allocated addresses. I'd be more
worried of the mess it left the HTML in!

After a bit of googeling, it turns out it's being going on for a while, bmi is
