...
Recently I needed to find a way to search for accounts an an active directory
...
To accomplish this I write a python script todo all this searching and just in
...
efficiently. I now make one ldap bind to each dc in turn, where as before I made
one ldap bind to each dc for each user! Plus the new version I slightly easier
