...
happened next was what only can be defined as Major Filesystem Corruption. I ran
the usual "sudo fsck -C -t ext3 -f -y /dev/mapper/ikaite-root" inside a script
...
After I mounted the filesystem there were no files left and 6000~ entries in
lost+found. Looks like I'll be reinstalling it!
