...
option is to just plug it in and from Gnome 3 is just works and can be set-up
...
breaking horrendously. All you need to do it create a new file in /etc/ppp/peers
...
The rest of the options are quite straight forward and they are all listed in
the pppd(8) man page.
