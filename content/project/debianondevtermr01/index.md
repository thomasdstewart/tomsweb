...
I used Debian based containers for this using podman, with any luck this will help future proof this process. The first step is to create a work directory and these containers. About 16G of disk space is required.
...
To speed up booting disable some services: apt-daily, apt-daily-upgrade, ModemManager, avahi-daemon, NetworkManager-wait-online:
```
 ...
 * Swtich to fbturbo https://forum.clockworkpi.com/t/r01-fbturbo-accelerated-2d-graphics-in-x11/8900
