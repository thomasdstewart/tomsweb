...
ExraIDE is a patch to the Linux kernel to enable more that the standard 20 ide
...
patch for the best part of 3 years. I was never really worth submitting to the
